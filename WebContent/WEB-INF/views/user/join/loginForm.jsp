...
$(function() {
	...
	$('.loginBtn').click(function() {
		...
		const $frm = $('<form action="${pageContext.request.contextPath}/user/join/loginCheck.do" method="post"></form>');
		const $inputID = $('<input type = "hidden" value ="' + mem_id + '" name = "mem_id"/>');
		const $inputPWD = $('<input type = "hidden" value ="' + mem_pass + '" name = "mem_pass"/>');
		$frm.append($inputID);
		$frm.append($inputPWD);
